...
def quote_form(service=''):
    return f'''<form class="quote-form" id="quote" action="mailto:{CONTACT['email']}" method="post" enctype="text/plain" aria-label="Φόρμα προσφοράς">
        ...
        <p class="form-note">Η φόρμα του preview ανοίγει email, δεν δηλώνει ψεύτικη επιτυχή αποστολή. Στο live μπορεί να συνδεθεί με backend μετά από έγκριση.</p>
...
<section class="hero hero-ink reveal" aria-label="Adapt Print hero">
    <div class="hero-copy">
        ...
        <div class="trust-strip" aria-label="Στοιχεία εμπιστοσύνης">
            <span><b>5,0/5</b> Google Maps</span><span><b>101</b> δημόσιες κριτικές*</span><span><b>Μακεδονίας 81</b> Πειραιάς</span>
        </div>
    </div>
...
<section class="ink-band reveal"><div><span class="micro-label">Κύρια υπηρεσία</span><h2>DTF με το μέτρο, χωρίς να χάνεται η λεπτομέρεια της στάμπας.</h2></div><p>Η σελίδα DTF παρουσιάζει πλέον την παραγωγή σαν διαδρομή: αρχείο, έλεγχος, προσφορά και εκτύπωση — με το ρολό και τη λεπτομέρεια να πρωταγωνιστούν.</p><a class="btn btn-light" href="/dtf-me-to-metro/">Άνοιγμα DTF σελίδας →</a></section>
...
<section class="production-strip reveal"><figure><img src="{img['s23']}" alt="Λεπτομέρεια DTF παραγωγής" loading="lazy"></figure><div><span class="micro-label">Ρολό / στάμπα / εφαρμογή</span><h2>Η διαδικασία φαίνεται σαν έξοδος εκτυπωμένου ρολού.</h2><p>Η οπτική διαδρομή κρατά την παραγωγή ξεκάθαρη χωρίς μακρύ υποχρεωτικό scrolling.</p></div></section>
...
<section class="info-cluster"><article><h2>Για ποιους είναι</h2><p>Για επαγγελματίες ένδυσης, ομάδες, εργαστήρια, brands και καταστήματα που χρειάζονται στάμπες έτοιμες για εφαρμογή.</p></article><article><h2>Τι πρέπει να ξέρουμε</h2><p>Ποσότητα, τελικές διαστάσεις, τύπο αρχείου, προθεσμία και αν υπάρχει ανάγκη παραλαβής ή αποστολής.</p></article><article><h2>Τι επιβεβαιώνεται</h2><p>Ωφέλιμο πλάτος, τιμή/τρόπος χρέωσης, ΦΠΑ, cutoff και χρόνος παραγωγής πρέπει να εγκριθούν από τον ιδιοκτήτη πριν το live.</p></article></section>
<section class="faq-section"><div class="section-head"><span class="kicker">FAQ</span><h2>Συχνές ερωτήσεις για DTF</h2></div>{faq([('Πόσο κοστίζει το DTF με το μέτρο;', 'Η τιμή πρέπει να επιβεβαιωθεί από την επιχείρηση μαζί με πλάτος, ΦΠΑ, ποσότητα, μεταφορικά και τυχόν χρέωση μακέτας.'), ('Υπάρχει ελάχιστη ποσότητα;', 'Θα προστεθεί η πραγματική ελάχιστη ποσότητα μετά την επιβεβαίωση παραγωγής.'), ('Μπορώ να στείλω αρχείο με link;', 'Ναι, στο πρωτότυπο ζητάμε σύνδεσμο αρχείου. Στο live μπορεί να μπει ασφαλές upload αν αποφασιστεί.')])}</section>
<section class="form-section"><div class="section-head"><span class="kicker">Προσφορά DTF</span><h2 id="quote-title">Ζητήστε προσφορά DTF</h2><p>Το anchor αφήνει χώρο κάτω από το sticky header ώστε να φαίνεται καθαρά ο τίτλος και η αρχή της φόρμας.</p></div>{quote_form('DTF με το μέτρο')}</section>''', '0.95')
...
{page_hero('Κατάλογος υπηρεσιών', 'Εκτυπώσεις για ιδιώτες και επαγγελματίες', 'Από DTF στάμπες και ένδυση μέχρι κούπες και διαφημιστικά είδη, κάθε υπηρεσία έχει πλέον δικό της οπτικό χαρακτήρα και καθαρό σύνδεσμο.', img['s07'], False, '<a class="btn btn-primary" href="/contact-us/#quote">Στείλτε αίτημα προσφοράς</a>')}
...
<section class="ink-band reveal"><div><span class="micro-label">Πριν την παραγωγή</span><h2>Καθαρό brief σημαίνει πιο καθαρή προσφορά.</h2></div><p>Προϊόν, ποσότητα, αρχείο, προθεσμία και τρόπος παραλαβής είναι τα βασικά που χρειάζονται για να ξεκινήσει σωστά η επικοινωνία.</p></section>{final_cta()}''')
...
{page_hero('Η εταιρεία', 'Η Adapt Print στον Πειραιά', 'Μια σύγχρονη επιχείρηση ψηφιακών εκτυπώσεων που ιδρύθηκε το 2023 και εξυπηρετεί ιδιώτες και επαγγελματίες με ένδυση, δώρα, DTF και διαφημιστικά είδη.', img['s21'], False)}
<section class="about-collage"><figure><img src="{img['s21']}" alt="Κατάστημα Adapt Print στον Πειραιά" loading="lazy"></figure><div><span class="kicker">Πραγματική εικόνα καταστήματος</span><h2>Λιγότερο DTF60 poster, περισσότερη επιχείρηση.</h2><p>Όπου υπάρχει διαθέσιμο φωτογραφικό υλικό καταστήματος/εργασίας, το χρησιμοποιούμε. Δεν παρουσιάζουμε κατασκευασμένους ανθρώπους ή εγκαταστάσεις ως πραγματικές φωτογραφίες.</p></div><figure><img src="{img['s24']}" alt="Παραγωγή εκτύπωσης σε κούπα" loading="lazy"></figure></section>{final_cta('Μιλήστε με την Adapt Print')}''')
...
<section class="contact-hero reveal"><div><span class="kicker">Επικοινωνία</span><h1>Πείτε μας τι θέλετε να τυπώσουμε.</h1><p>Καθαρή διάκριση τηλεφώνου, WhatsApp, email, καταστήματος και φόρμας — χωρίς μεγάλο, επαναλαμβανόμενο CTA.</p><div class="contact-methods"><a href="{CONTACT['phone1_href']}"><b>{CONTACT['phone1_label']}</b><span>Σταθερό</span></a><a href="{CONTACT['phone2_href']}"><b>{CONTACT['phone2_label']}</b><span>Κινητό</span></a><a href="{CONTACT['whatsapp']}" target="_blank" rel="noopener noreferrer"><b>WhatsApp</b><span>Γρήγορη αποστολή</span></a><a href="{CONTACT['email_href']}"><b>{CONTACT['email']}</b><span>Email</span></a></div></div><aside class="shop-card"><h2>Κατάστημα</h2><p>{CONTACT['address']}</p><a class="btn btn-secondary" href="{CONTACT['maps']}" target="_blank" rel="noopener noreferrer">Άνοιγμα χάρτη</a><h3>Ωράριο*</h3><ul class="hours-list">{''.join(f'<li><span>{d}</span><b>{h}</b></li>' for d,h in HOURS)}</ul><p class="small">*Χρειάζεται τελική επιβεβαίωση γιατί το Google Maps εμφανίζει διαφορετικές ώρες.</p></aside></section>
...
legal_terms = '<section class="legal-page"><span class="kicker">Νομικά</span><h1>Όροι χρήσης και συναλλαγών</h1><p>Προσχέδιο placeholder για τη static έκδοση. Οι τελικοί όροι πρέπει να εγκριθούν από ιδιοκτήτη/νομικό και να περιγράφουν πραγματικά: προσφορά, μακέτα, πληρωμή, παραγωγή, παράδοση, ακύρωση και προσωποποιημένα προϊόντα.</p></section>'
legal_privacy = '<section class="legal-page"><span class="kicker">Νομικά</span><h1>Πολιτική απορρήτου και προσωπικών δεδομένων</h1><p>Προσχέδιο placeholder. Πριν το live χρειάζεται χαρτογράφηση φόρμας, email, αρχείων μακέτας, hosting, analytics και τυχόν CRM/CMP. Το link θα είναι πάντα ορατό σε desktop/mobile και πριν την υποβολή φόρμας.</p></section>'
